...
export default function Home() {
  ...
  // Sử dụng Hook useQuery để lấy dữ liệu từ API Openweather
  // Với place được lấy từ biến toàn cục place kiểu Atoms
  ...
  // doi thoi gian cho 3 ngon ngu : Viet , Trung, Anh
  // const dateLocale = locale === "vi" ? vi : locale === "cn" ? zhCN : enUS;

  // doi thoi gian cho 3 ngon ngu : Viet ,  Anh
